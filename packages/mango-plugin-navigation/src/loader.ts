...
export default {
  ...
  // fetch nav menus
  getNavMenu: async function (ctx, id: number, args = {}) {
    return this.job(ctx, [API.NavMenu, id].join('/'), args)
  },

  // fetch nav menu items
  getNavItems: async function (ctx, id: number, args = {}) {
    return this.job(ctx, [API.NavItems, id].join('/'), args)
  },

  // fetch nav location
  getNavLocation: async function (ctx, name: string, args = {}) {
  ...
  // fetch nav locations
  getNavLocations: async function (ctx, args = {}) {
