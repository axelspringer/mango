...
export declare const NODE_ENV: string, SSM_WP: string, SSM_ENV: string, SSM_PORT: string, SSM_PLUGINS: string, SSM_HOST: string, SSM_TOKEN: string, SSM_SECRET: string, SSM_MAX_AGE: string, SSM_TTL: string, MANGO_WP: string, MANGO_ENV: string, MANGO_PORT: string, MANGO_PLUGINS: string, MANGO_HOST: string, MANGO_TOKEN: string, MANGO_SECRET: string, MANGO_MAX_AGE: string, MANGO_TTL: string;
